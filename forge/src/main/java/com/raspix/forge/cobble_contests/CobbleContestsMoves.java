...
public class CobbleContestsMoves implements JsonDataRegistry<ContestMoves.MoveData> {
    ...
    public ResourceLocation getId() {
        return new ResourceLocation(CobbleContestsForge.MOD_ID, "contest_moves");
    }
    ...
    private <T> T loadMechanic(ResourceManager manager, String name, Class<T> clazz) {
        try (var inputStream = manager.getResourceOrThrow(new ResourceLocation(CobbleContestsForge.MOD_ID, "moves/" + name + ".json")).open()) {
